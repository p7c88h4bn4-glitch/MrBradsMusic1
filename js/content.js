...
window.SITE = {
  ...
  programs: [
    {
      ...
      audience: "Best for ages 0–7 and family audiences.",
      shortDescription:
    ...
    },
    {
      ...
      audience: "Perfect for 2nd to 6th birthday celebrations.",
      shortDescription:
  ...
  testimonials: [
    {
      quote: "We love having Mr. Brad at our library! He is a regular part of our programming, and families always ask when he'll be back. His combination of music, audience participation, and positive energy keeps children engaged from beginning to end. His performances are consistently a favorite among our patrons!",
      source: "Cassidy, Youth Services Librarian"
    },
    {
      quote: "Mr. Brad came to my son's 3rd birthday party, and he was absolutely amazing! His songs, incredible talent playing several musical instruments, and fun, energetic personality kept the kids completely engaged from beginning to end. It was truly the highlight of the birthday party!\n\nBabies, toddlers, and older kids were all dancing, singing, listening, and completely captivated by the show. It was so special to see children of all ages having such a great time together.\n\nI highly recommend Mr. Brad for any children's event. You won't regret it! He brings so much fun, joy, and excitement, and helped make my son's birthday incredibly memorable!",
      source: "Johana, Birthday Party Mom"
    },
    {
      quote: "Mr. Brad has been a beloved part of The Robin’s Nest Preschool for many years, and our children absolutely adore him! His high-energy, interactive performances and exceptional musical talent keep children engaged from start to finish. He has a wonderful gift for connecting with young learners while introducing them to a variety of instruments in a fun and memorable way. We wholeheartedly recommend Mr. Brad to any school, church, or organization looking for an outstanding children's entertainer!",
      source: "Anne Martinelli, Director, The Robin's Nest Preschool"
    }
  ],
  ...
  apps: [
    ...
    {
      name: "Interval Lab",
      description: "An interactive ear-training tool for practicing musical intervals with listening exercises and visual patterns.",
      screenshot: "",
      openUrl: "https://intervallab.netlify.app",
      learnMoreUrl: ""
    },
    {
      name: "Harmony Pads",
      description: "A tool for songwriters to build chord progressions with interactive harmony pads.",
      screenshot: "",
      openUrl: "https://harmonypads.netlify.app",
      learnMoreUrl: ""
    },
    {
      name: "Chord Box Builder",
      description: "Create clear, customizable chord-box diagrams for guitar lessons, practice materials, and songwriting notes.",
      screenshot: "",
      openUrl: "https://chordboxbuilder.netlify.app/",
      learnMoreUrl: ""
    },
    {
      name: "Tab Builder",
      description: "Build and organize guitar tablature for lessons, practice, and sharing musical ideas.",
      screenshot: "",
      openUrl: "https://tabbuilder.netlify.app/",
      learnMoreUrl: ""
    },
    {
      name: "More apps coming soon 🎵",
      description: "Piano Learning App, Drum Learning App, and other educational music tools are in development. Check back soon!",
      screenshot: "",
      openUrl: "",
      learnMoreUrl: ""
    }
